...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference("Chatroom.count") do
      post chatrooms_url, params: { chatroom: { owner_id: @chatroom.owner_id, partner_id: @chatroom.partner_id, title: @chatroom.title } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { owner_id: @chatroom.owner_id, partner_id: @chatroom.partner_id, title: @chatroom.title } }
